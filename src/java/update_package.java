...
public class update_package extends HttpServlet
{
...
String q2="update package set drop_visit='"+Drop_Visit+"',drive_pass='"+Drive_Pass+"',drive_over='"+Drive_Over+"',ac='"+AC+"',non_ac='"+Non_AC+"',add_guest='"+Add_guest+"',guide_charges='"+Guide_Charges+"'";
