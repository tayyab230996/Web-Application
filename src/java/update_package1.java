...
public class update_package1 extends HttpServlet
{
...
String q2="update package_2 set drop_visit='"+Drop_Visit+"',drive_pass='"+Drive_Pass+"',drive_over='"+Drive_Over+"',ac='"+AC+"',non_ac='"+Non_AC+"',add_guest='"+Add_guest+"',guide_charges='"+Guide_Charges+"'";
