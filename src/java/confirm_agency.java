...
public class confirm_agency extends HttpServlet
{
...
String hiddenEmail = req.getParameter("hid-email");
String q2="update travel_agency set active='yes' where email='"+hiddenEmail+"'";
pw.println(q2);
int x=stmt.executeUpdate(q2);
System.out.println(x);
        if(x>0)
        {
        String q1="select * from travel_agency where active='no'";
...
"        <td width=\"8%\">"+rs.getString(12)+"</td>\n" +
"        <td width=\"8%\"><form method=\"post\" action=\"confirm_agency\"><input type=\"submit\" value=\"Confirm\">\n" +
"         </form></td>\n" +
"    </tr>");
}
pw.println("</table>\n" +
